...
#
# Script generated by Vivado on Sat May 11 15:10:55 CEST 2024
# SW Build 4126759 on Thu Feb  8 23:52:05 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : simpleComputer.sh
...
#
# Usage        : simpleComputer.sh
#                simpleComputer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                simpleComputer.sh [-reset_run]
#                simpleComputer.sh [-reset_log]
#                simpleComputer.sh [-help]
#
...
# script info
echo -e "simpleComputer.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./simpleComputer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot simpleComputer xil_defaultlib.simpleComputer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim simpleComputer -key {Behavioral:sim_1:Functional:simpleComputer} -tclbatch cmd.tcl -protoinst "protoinst_files/simpleComputer.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/juan/Xilinx/v2023P2/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb simpleComputer.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./simpleComputer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: simpleComputer.sh [-help]\n\
Usage: simpleComputer.sh [-step]\n\
Usage: simpleComputer.sh [-lib_map_path]\n\
Usage: simpleComputer.sh [-reset_run]\n\
Usage: simpleComputer.sh [-reset_log]\n\
Usage: simpleComputer.sh [-keep_index]\n\
Usage: simpleComputer.sh [-noclean_files]\n\n\
